namespace Frida {
	...
	public sealed class LinuxHostSession : LocalHostSession {
		...
		construct {
			...
			var blob32 = Frida.Data.Agent.get_xiam_32_so_blob ();
			var blob64 = Frida.Data.Agent.get_xiam_64_so_blob ();
			var emulated_arm = Frida.Data.Agent.get_xiam_arm_so_blob ();
			var emulated_arm64 = Frida.Data.Agent.get_xiam_arm64_so_blob ();
			agent = new AgentDescriptor (PathTemplate ("xiam-<arch>.so"),
				new Bytes.static (blob32.data),
				new Bytes.static (blob64.data),
				new AgentResource[] {
					new AgentResource ("xiam-arm.so", new Bytes.static (emulated_arm.data), tempdir),
					new AgentResource ("xiam-arm64.so", new Bytes.static (emulated_arm64.data), tempdir),
				},
				AgentMode.INSTANCED,
				tempdir);
#endif
	...
	private sealed class AndroidHelperService : Object, AndroidHelperTransport {
		...
		construct {
			...
			worker_thread = new Thread<void> ("xiam-ah", run);
		}
