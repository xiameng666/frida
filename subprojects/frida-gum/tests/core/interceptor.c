...
TESTCASE (function_data)
{
  ...
  g_assert_cmpint (gum_interceptor_attach (fixture->interceptor,
      target_nop_function_a, listener, a_data,
      GUM_ATTACH_FLAGS_NONE), ==, GUM_ATTACH_OK);
  g_assert_cmpint (gum_interceptor_attach (fixture->interceptor,
      target_nop_function_b, listener, b_data,
      GUM_ATTACH_FLAGS_NONE), ==, GUM_ATTACH_OK);
...
TESTCASE (already_attached)
{
  ...
  g_assert_cmpint (gum_interceptor_attach (fixture->interceptor,
      ...
      NULL,
      GUM_ATTACH_FLAGS_NONE), ==, GUM_ATTACH_ALREADY_ATTACHED);
}
